...
Source0  : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.8/bolt-0.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579207229
...
cp %{_builddir}/bolt-0.8/COPYING %{buildroot}/usr/share/package-licenses/bolt/01a6b4bf79aca9b556822601186afab86e8c4fbf

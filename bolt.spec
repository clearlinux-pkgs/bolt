...
Source0  : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.9.8/bolt-0.9.8.tar.gz
...
%prep
%setup -q -n bolt-0.9.8
cd %{_builddir}/bolt-0.9.8
pushd ..
cp -a bolt-0.9.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720459708

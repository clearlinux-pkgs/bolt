...
Version  : 0.9.2
Release  : 10
URL      : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.9.2/bolt-0.9.2.tar.gz
Source0  : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.9.2/bolt-0.9.2.tar.gz
...
%prep
%setup -q -n bolt-0.9.2
cd %{_builddir}/bolt-0.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643396949
...
cp %{_builddir}/bolt-0.9.2/COPYING %{buildroot}/usr/share/package-licenses/bolt/01a6b4bf79aca9b556822601186afab86e8c4fbf

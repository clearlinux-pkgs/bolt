...
Version  : 0.9.5
Release  : 13
URL      : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.9.5/bolt-0.9.5.tar.gz
Source0  : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.9.5/bolt-0.9.5.tar.gz
...
%prep
%setup -q -n bolt-0.9.5
cd %{_builddir}/bolt-0.9.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672932836

...
Version  : 0.9.4
Release  : 12
URL      : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.9.4/bolt-0.9.4.tar.gz
Source0  : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.9.4/bolt-0.9.4.tar.gz
...
%prep
%setup -q -n bolt-0.9.4
cd %{_builddir}/bolt-0.9.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672165545

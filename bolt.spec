...
Version  : 0.9.3
Release  : 11
URL      : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.9.3/bolt-0.9.3.tar.gz
Source0  : https://gitlab.freedesktop.org/bolt/bolt/-/archive/0.9.3/bolt-0.9.3.tar.gz
...
%prep
%setup -q -n bolt-0.9.3
cd %{_builddir}/bolt-0.9.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662673434
